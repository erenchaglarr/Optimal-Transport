...
def get_cifar10_dataset(data_root=DATA_DIR, train=True, download=True):
...
# Optional: keep this if the rest of your code still calls get_mnist_dataset(...)
# This makes your old code use CIFAR-10 without changing every import.
